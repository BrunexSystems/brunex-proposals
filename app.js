    ...
    proposal.innerHTML = `
      ...
      <div class="workspace">
        <section class="config-panel">
          ...
          <section class="service-rates scrollspy-section" id="additional-services"><p class="section-kicker">ADDITIONAL SERVICES</p><h3>Hourly rates</h3><div class="service-rate-grid"><div><span>Product entry</span><strong>${money.format(config.rates.product_entry)}<small>/hour</small></strong><p>Catalog and product-data entry beyond the selected package allowance.</p></div><div><span>Additional design &amp; development</span><strong>${money.format(config.rates.development)}<small>/hour</small></strong><p>Applies only to client-approved technical, design, or development work outside the agreed project scope. Brunex will provide an estimate and obtain written approval before billable work begins.</p></div></div><p class="service-note">Additional design and development is billed in 15-minute increments. Care-plan edit hours do not apply to bulk product-entry work.</p></section>
